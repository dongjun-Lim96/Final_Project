...
<main>
  ...
  <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
    ...
    <ul class="list-unstyled ps-0">
      ...
      <li class="mb-1">
        <button class="btn btn-toggle align-items-center rounded collapsed custom-button" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>고객관리
        </button>
      ...
      <li class="mb-1">
        <button class="btn btn-toggle align-items-center rounded collapsed custom-button" data-bs-toggle="collapse" data-bs-target="#orders-collapse" aria-expanded="false">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>주문관리
        </button>
