   ...
   <table class="table">
      <c:if test="${loginInfo.adminCheck eq 1}">
         <tr>
            <td colspan="6" align="right"><a class="table__write-link"
               href="write.nt?pageNumber=${pageInfo.pageNumber}">글쓰기</a></td>
         </tr>
      </c:if>
      ...
      <c:forEach var="notice" items="${noticeLists}">
         <tr>
            ...
            <td><a
               href="detailView.nt?noticeNumber=${notice.noticeNumber}&pageNumber=${pageInfo.pageNumber}">${notice.noticeContent}</a></td>
