      ...
      <table width="600px" >
         ...
         <dl>
            ...
            <dd>
               ...
               <dd>
               <span id="eventTitle_hint"  style="color:#0DCAF0; display: inline-block; text-align: center; width: 100%;"></span>
            </dd>
         </dl>
           ...
           <dl>
            ...
            <dd>
               <span id="eventContent_hint"  style="color:#0DCAF0; display: inline-block; text-align: center; width: 100%;"></span>
            </dd>
         </dl>
