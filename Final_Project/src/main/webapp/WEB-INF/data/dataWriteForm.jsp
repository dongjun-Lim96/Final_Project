...
<div class="login_cont member_cont">
   ...
   <form:form commandName="dataBean"  action="write.dt"  method="post" enctype="multipart/form-data">
   ...
   <div class="mem_cont">
      ...
      <div class="myinfo_cont refund_info">
         ...
         <dl>
            ...
            <dd>
               <input name="dataTitle" class="input" type="text" id="dataTitle" maxlength="20" value="${dataBean.dataTitle}"/>
                  <span id="dataTitle_hint"  style="color:#0DCAF0;"></span>
               <div class="comment">
                   <form:errors
                  cssClass="comment" path="dataTitle" />
               </div>
            </dd>
         </dl>
         <dl>
            ...
            <dd>
               <input name="dataContent" class="input" type="text" id="dataContent" maxlength="200" />
               <span id="dataContent_hint"  style="color:#0DCAF0;"></span>
               <div class="comment">
                  <form:errors
                  cssClass="comment" path="dataContent" />
               </div>
            </dd>
         </dl>
   ...
   <div class="btn_list">
      <input type="submit" class="moreBtn pointColor pointBorder" id="btn_submit" value="무료자료 등록" />
      <input type="reset" class="moreBtn pointColor pointBorder"  value="다시 작성" />
      <input type="button" class="moreBtn pointColor pointBorder" onClick="location.href = 'list.dt?pageNumber=${param.pageNumber}'" value="목록보기" />
   </div>
...
<script type="text/javascript">
  ...
  checkCapsLock(document.querySelector('input[name=dataContent]'), '#dataContent_hint');
  checkCapsLock(document.querySelector('input[name=dataTitle]'), '#dataTitle_hint');
</script>
