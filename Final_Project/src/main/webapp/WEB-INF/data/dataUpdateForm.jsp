...
<div class="login_cont member_cont">
   ...
   <form:form commandName="data" action="updateData.dt" method="post"
      enctype="multipart/form-data">
      <div class="mem_cont">
      <table width="600px" >
               <div class="myinfo_cont refund_info">
   <dl>
            <dt colspan="2"><a href="list.dt">글목록</a> <input type="hidden"
               name="dataNumber" value="${data.dataNumber }"> <input
         ...
         <dl>
            ...
            <dd><input type="text"  class="input" name="dataTitle"maxlength="20"
               value="${data.dataTitle}"> 
               <span id="dataTitle_hint"  style="color:#0DCAF0;"></span>
               <form:errors cssClass="err" path="dataTitle" />         
               </dd>
         </dl>
              <dl>
            <dt>이미지 <span class="pointColor">*</span></dt>
            <dd><img
               src="<%=request.getContextPath()%>/resources/${data.dataImage}"
               width="200" height="200"> <br> <input type="file"
               name="upload" id="upload" value="${data.upload}"> <input
               type="hidden" name="upload2" value="${data.dataImage}">
</dd>
         </dl>
            ...
            <dd>
            <input name="dataContent"  class="input" type="text" maxlength="20" value="${data.dataContent}"/>
               <span id="dataContent_hint"  style="color:#0DCAF0;"></span>
               <form:errors cssClass="err" path="dataContent" />
               </dd>
         </div>
</div>
