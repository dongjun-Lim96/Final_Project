...
<div class="login_cont member_cont">
	...
	<div class="mem_cont">
		...
		<div class="myinfo_cont refund_info">
		 	...
		 	<dl>
				<dt style=" font-size: 25px;">강의명 </dt>
				<dt style=" font-size: 25px;">${unitBean.cousreName } </dt>					
			</dl>
			<c:if test="${not empty unitBean.unit1}">
			<dl>
				<dt>목차 1 </dt>
				<dt>${unitBean.unit1 }</dt>						
			</dl>
			</c:if>
			
			
			<c:if test="${not empty unitBean.unit2}">
			<dl>
				<dt>목차 2 </dt>
				<dt>${unitBean.unit2 }</dt>						
			</dl>
			</c:if>
			
			<c:if test="${not empty unitBean.unit3}">
			<dl>
				<dt>목차 3 </dt>
				<dt>${unitBean.unit3 }</dt>						
			</dl>
			</c:if>
			<c:if test="${not empty unitBean.unit4}">
			<dl>
				<dt>목차 4 </dt>
				<dt>${unitBean.unit4 }</dt>						
			</dl>
			</c:if>
			<c:if test="${not empty unitBean.unit5}">
			<dl>
				<dt>목차 5 </dt>
				<dt>${unitBean.unit5 }</dt>						
			</dl>
			</c:if>
			<c:if test="${not empty unitBean.unit6}">
			<dl>
				<dt>목차 6 </dt>
				<dt>${unitBean.unit6 }</dt>						
			</dl>
			</c:if>
			<c:if test="${not empty unitBean.unit7}">
			<dl>
				<dt>목차 7 </dt>
				<dt>${unitBean.unit7 }</dt>						
			</dl>
			</c:if>
			<c:if test="${not empty unitBean.unit8}">
			<dl>
				<dt>목차 8 </dt>
				<dt>${unitBean.unit8 }</dt>						
			</dl>
			</c:if>
			<c:if test="${not empty unitBean.unit9}">
			<dl>
				<dt>목차 9 </dt>
				<dt>${unitBean.unit9 }</dt>						
			</dl>
			</c:if>
			<c:if test="${not empty unitBean.unit10}">
			<dl>
				<dt>목차 10 </dt>
				<dt>${unitBean.unit10 }</dt>						
			</dl>
			</c:if>
