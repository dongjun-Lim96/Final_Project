...
%>
<script type="text/javascript" src="<%=conPath%>/resources/js/loginscript.js"></script>
	...
	<div class="mem_cont">
		...
		<div class="myinfo_cont refund_info">
			...
			<dl>
				...
				<dd>
					<input name="userId" class="input input_m2" id="userId" maxlength="20" type="text"  placeholder="영문 또는 숫자 2~20자리" onkeydown="keyd()" />&nbsp
					<input type="button" class="moreBtn pointColor pointBorder" value="중복체크" onClick="duplicate()" > 
