...
<br><br>
  ...
  <div class="privacy">
<p>(주)한국라이센스개발원(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립·공개합니다.</p>

<h3>제1조(개인정보의 처리목적)</h3>
<p>회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</p> 
<dl>
  <dt>1. 홈페이지 회원 가입 및 관리</dt>
     <dd>회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지, 만 14세 미만 아동의 개인정보 처리시 법정대리인의 동의여부 확인, 각종 고지·통지, 고충처리 등을 목적으로 개인정보를 처리합니다.</dd> 
  <dt>2. 재화 또는 서비스 제공</dt>
     <dd>물품배송, 서비스 제공, 계약서·청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금결제·정산, 채권추심 등을 목적으로 개인정보를 처리합니다.</dd> 
  <dt>3. 고충처리</dt> 
     <dd>민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 등의 목적으로 개인정보를 처리합니다.</dd>
</dl>
<h3>제2조(개인정보의 처리 및 보유기간)</h3>
   <p>① 회사는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.</p> 
   <p>② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.</p> 
   <dl>
   <dt>1. 홈페이지 회원 가입 및 관리 : 홈페이지 탈퇴 후 5일까지</dt> 
     <dd>다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료시까지</dd> 
     <dd>1) 관계 법령 위반에 따른 수사·조사 등이 진행중인 경우에는 해당 수사·조사 종료시까지</dd> 
     <dd>2) 홈페이지 이용에 따른 채권·채무관계 잔존시에는 해당 채권·채무관계 정산시까지</dd> 
   <dt>2. 재화 또는 서비스 제공 : 재화·서비스 공급완료 및 요금결제·정산 완료시까지</dt>
     <dd>다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료시까지</dd> 
     <dd>1) 「전자상거래 등에서의 소비자 보호에 관한 법률」에 따른 표시·광고, 계약내용 및 이행 등 거래에 관한 기록</dd> 
        <dd>- 표시·광고에 관한 기록 : 6월</dd> 
        <dd>- 계약 또는 청약철회, 대금결제, 재화 등의 공급기록 : 5년</dd> 
        <dd>- 소비자 불만 또는 분쟁처리에 관한 기록 : 3년</dd> 
     <dd>2)「통신비밀보호법」제41조에 따른 통신사실확인자료 보관</dd>
       <dd>- 가입자 전기통신일시, 개시·종료시간, 상대방 가입자번호, 사용도수, 발신기지국 위치추적자료 : 1년 </dd>
       <dd>- 컴퓨터통신, 인터넷 로그기록자료, 접속지 추적자료 : 3개월</dd>
   </dl>
...
<h3>제3조(개인정보처리의 위탁)</h3>
   ...
   <dl>
   <dt>1. 시스템 운영</dt> 
    <dd>- 위탁받는 자 (수탁자) : (주)맑은소프트</dd> 
    <dd>- 위탁하는 업무의 내용 : 교육관리시스템(LMS) 관리 및 유지보수</dd>
   </dl>
...
<h3>제4조(정보주체의 권리·의무 및 행사방법)</h3>
   ...
   <p>⑥ 만 14세 미만 아동의 법정대리인의 법령 상의 권리를 보장합니다. (아동의 개인정보에 대한 열람, 정정, 삭제, 개인정보처리정지요구권)</p>

<h3>제5조(처리하는 개인정보 항목)</h3>
   <p>회사는 다음의 개인정보 항목을 처리하고 있습니다.</p> 
   <dl>
   <dt>1. 홈페이지 회원 가입 및 관리</dt> 
    <dd>- 필수항목 : 성명, 아이디, 비밀번호, 이메일, 생년월일, 성별</dd> 
    <dd>- 선택항목 : 주소, 전화번호, 아이핀번호</dd> 
   <dt>2. 재화 또는 서비스 제공</dt>  
    <dd>- 필수항목 : 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 이메일주소, 아이핀번호, 신용카드번호, 은행계좌정보 등 결제정보</dd> 
    <dd>- 선택항목 : 관심분야, 과거 구매내역</dd>  
   <dt>3. 인터넷 서비스 이용과정에서 아래 개인정보 항목이 자동으로 생성되어 수집될 수 있습니다.</dt> 
...
<h3>제7조(개인정보 자동수집장치 이용여부)</h3>
   <p>쿠키(Cookie)를 설치, 운영하고 있고 이용자는 이를 거부할 수 있습니다.</p> 
   <dl>
   <dt>1. 쿠키란 무엇인가?</dt>
   <dd>쿠키란 웹사이트를 운영하는데 이용되는 서버가 이용자의 브라우저에 보내는 아주 작은 텍스트 파일로서 이용자의 컴퓨터에 저장됩니다.</dd>
   <dt>2. 쿠키를 왜 사용하나?</dt> 
   <dd>쿠키를 통해 이용자가 선호하는 설정 등을 저장하여 이용자에게 보다 빠른 웹 환경을 지원하며, 편리한 이용을 위해 서비스 개선에 활용합니다. 이를 통해 이용자는 보다 손쉽게 서비스를 이용할 수 있게 됩니다.</dd>
   <dt>3. 쿠키를 수집하지 못하게 거부하고 싶다면?</dt> 
   <dd>이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서, 이용자는 웹 브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 모든 쿠키의 저장을 거부할 수도 있습니다. 다만 쿠키 설치를 거부할 경우 웹 사용이 불편해지며 로그인이 필요한 일부 서비스 이용에 어려움이 있을 수 있습니다.</dd>
   </dl>
   
<h3>제8조(개인정보의 안전성 확보조치)</h3>
   <p>회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
   <dl>
   <dd>- 관리적 조치 : 내부관리계획 수립·시행, 정기적 직원 교육 등</dd> 
   <dd>- 기술적 조치 : 개인정보처리시스템 등의 접근권한 관리, 접근통제시스템 설치, 고유식별정보 등의 암호화, 보안프로그램 설치</dd> 
...
<h3>제11조(권익침해 구제방법)</h3>
   ...
   <dt>▶ 경찰청 사이버테러대응센터 : 1566-0112 (www.netan.go.kr)</dt> 
   </dl>
